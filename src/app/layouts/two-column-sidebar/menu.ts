...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                id: 34,
                label: 'MENUITEMS.APPS.LIST.TEACHER',
                parentId: 24,
                isCollapsed: true,
                subItems: [
                    {
