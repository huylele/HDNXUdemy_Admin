...
@Component({
  selector: 'app-list-learning-with-teacher',
  templateUrl: './list-learning-with-teacher.component.html',
  styleUrls: ['./list-learning-with-teacher.component.scss'],
  providers: [DecimalPipe]
})

// List Component
export class ListLearningWithTeacherComponent {
